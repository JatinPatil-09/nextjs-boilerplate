...
export const env = createEnv({
  ...
  server: {
    ...
    NEXTAUTH_URL: z.string().url().describe("Canonical URL of your site"),
    ...
    // Email Configuration
    EMAIL_SERVER_HOST: z.string().describe("SMTP server host").optional(),
    EMAIL_SERVER_PORT: z.coerce
      ...
      .optional(),
    EMAIL_SERVER_USER: z.string().describe("SMTP server username").optional(),
  ...
  client: {
    ...
    NEXT_PUBLIC_JSONPLACEHOLDER_API_URL: z
      .string()
      .url()
      .default("https://jsonplaceholder.typicode.com")
      .describe("JSONPlaceholder API base URL"),
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_JSONPLACEHOLDER_API_URL:
      process.env.NEXT_PUBLIC_JSONPLACEHOLDER_API_URL,
